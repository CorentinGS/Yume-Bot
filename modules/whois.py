...
class Whois:
    ...
    async def whois(self, ctx, user: discord.Member):
        ...
        embed.add_field(name="Joined", value=user.joined_at.strftime('%A - %B - %e - %g at %H:%M'), inline=True)
        embed.add_field(name="Nick", value=user.nick, inline=True)
        embed.add_field(name="Created", value=user.created_at.strftime('%A - %B - %e - %g at %H:%M'), inline=True)
